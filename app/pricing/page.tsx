...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we use enterprise-grade security with 256-bit SSL encryption, regular backups, and SOC 2 compliance.',
    },
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Choose the perfect plan for your real estate business. Start with a 14-day free trial, 
              ...
              {plans.map((plan, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Card className={`h-full ${plan.popular ? 'ring-2 ring-black shadow-2xl' : 'shadow-lg'} hover:shadow-xl transition-all duration-300`}>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Compare features across all plans and find the perfect fit for your business
              </p>
            </motion.div>
              ...
              {[
                {
                  icon: Calculator,
                  title: 'AI Valuations',
                  description: 'Get instant property valuations powered by machine learning',
                },
                {
                  icon: Users,
                  title: 'Lead Management',
                  description: 'Smart CRM with automated lead scoring and follow-ups',
                },
                {
                  icon: TrendingUp,
                  title: 'Market Analytics',
                  description: 'Real-time market trends and investment insights',
                },
                {
                  icon: FileText,
                  title: 'Document Automation',
                  description: 'Generate contracts and legal documents automatically',
                },
                {
                  icon: MessageSquare,
                ...
                },
                {
                  icon: Headphones,
                  title: '24/7 Support',
                  description: 'Round-the-clock support from real estate experts',
                },
                {
                  icon: Building2,
                  title: 'Multi-Office',
                  description: 'Manage multiple offices and teams from one platform',
                },
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join thousands of successful agents and agencies using Quinex to close more deals
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
